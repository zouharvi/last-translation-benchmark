...
MODEL_LIBRARY = [
    ...
    {"name": "GPT-6 Astra", "fn": functools.partial(translate_openrouter, model="openai/gpt-6-astra"), "support_image": True, "support_audio": False, "support_video": False, "support_textonly": True},
    ...
    {"name": "Gemini 3.8 Flash", "fn": functools.partial(translate_openrouter, model="google/gemini-3.8-flash"), "support_image": True, "support_audio": True, "support_video": True, "support_textonly": True},
...
async def get_leaderboard_results(
    ...
    for participant in participants:
        ...
        if "display_va" in participant["info"]:
            model_out["display_va"] = participant["info"]["display_va"]
